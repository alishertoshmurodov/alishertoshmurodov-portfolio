    ...
    <div className="projects__project">
      <div className="projects__project-img">
        ...
        <div className="projects__project-links">
          <a href={project.live} rel="noreferrer" target="_blank" className="button-main">View project</a>
          <a href={project.github} rel="noreferrer" target="_blank" className="button-main">View Code</a>
        </div>
      </div>
